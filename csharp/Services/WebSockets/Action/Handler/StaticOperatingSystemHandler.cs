...
namespace csharp.Services.WebSockets.Action.Handler
{
    public class StaticOperatingSystemHandler : ActionHandler
    {
        ...
        public StaticOperatingSystemHandler(IServiceProvider serviceProvider, WebSocketConnection webSocket, Action action) : base(serviceProvider, webSocket, action)
        {
        }
